...
class Rings extends Component {
    ...
    static StrengthRing() {
        ...
        return {
            itemName: "Ring of Strength", itemImage: ringOneImage, itemDescription: "Rusted and dull",
            itemType: "ring", itemRarity: randomItemRarity, itemLevel: 1, itemIsEquipped: false, itemIsLocked: false,
    ...
    static ChanceRing() {
        let randomItemRarity = this.calculateNewItemRarity();
        return {
            itemName: "Ring of Chances", itemImage: ringOneImage, itemDescription: "Rusted and dull",
            itemType: "ring", itemRarity: randomItemRarity, itemLevel: 1, itemIsEquipped: false, itemIsLocked: false,
            itemValue: this.calculateNewEquipmentStatsRange(500, 1, 1.05, 5, randomItemRarity),
            itemStats: {
                bonusAttack: this.calculateNewEquipmentStatsRange(2, 1, 1.07, 3, randomItemRarity),
    ...
    static HealthRing() {
        let randomItemRarity = this.calculateNewItemRarity();
        return {
            itemName: "Ring of Health", itemImage: ringOneImage, itemDescription: "Rusted and dull",
            itemType: "ring", itemRarity: randomItemRarity, itemLevel: 1, itemIsEquipped: false, itemIsLocked: false,
            itemValue: this.calculateNewEquipmentStatsRange(500, 1, 1.05, 5, randomItemRarity),
            itemStats: {
                bonusAttack: this.calculateNewEquipmentStatsRange(2, 1, 1.07, 3, randomItemRarity),
    ...
    static FuryRing() {
        let randomItemRarity = this.calculateNewItemRarity();
        return {
            itemName: "Ring Of Fury", itemImage: ringOneImage, itemDescription: "Rusted and dull",
            itemType: "ring", itemRarity: randomItemRarity, itemLevel: 1, itemIsEquipped: false, itemIsLocked: false,
            itemValue: this.calculateNewEquipmentStatsRange(500, 1, 1.05, 5, randomItemRarity),
            itemStats: {
                bonusAttack: this.calculateNewEquipmentStatsRange(2, 1, 1.07, 3, randomItemRarity),
    ...
    static ElderRing() {
        let randomItemRarity = this.calculateNewItemRarity();
        return {
            itemName: "Elder Ring", itemImage: ringOneImage, itemDescription: "Rusted and dull",
            itemType: "ring", itemRarity: randomItemRarity, itemLevel: 1, itemIsEquipped: false, itemIsLocked: false,
            itemValue: this.calculateNewEquipmentStatsRange(500, 1, 1.05, 5, randomItemRarity),
            itemStats: {
                bonusAttack: this.calculateNewEquipmentStatsRange(2, 1, 1.07, 3, randomItemRarity),
